...
def alphabetic_number_sort(array)
  words_array = array.map { |number| WORDS[number] }
  words_array.sort.map { |word| WORDS.key(word) }
end
...
p alphabetic_number_sort([3, 5, 6]) == [5, 6, 3]
...
def alphabetic_number_sort_2(numbers_array)
  numbers_array.sort_by { |number| NUMBER_WORDS[number] }
end
...
p alphabetic_number_sort_2([3, 5, 6]) == [5, 6, 3]
